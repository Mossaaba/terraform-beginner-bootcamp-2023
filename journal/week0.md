...
- **Providers** is an interface to APIs that will allow to create of resources in Terraform.
...
When attempting to run `terraform login` it will launch bash a shwoing view to generate a token. However, it does not work as expected in Gitpod VsCode in the browser.
